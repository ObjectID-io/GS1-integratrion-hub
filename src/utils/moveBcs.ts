...
export type GS1ResourceCreate = {
  ...
  manufacturing_location_gln: string;
...
const MoveStringBcs = bcs.struct("std::string::String", {
  bytes: bcs.vector(bcs.u8()),
});

// KeyValue { key: String, value: String }
const KeyValueBcs = bcs.struct("KeyValue", {
  key: MoveStringBcs,
  value: MoveStringBcs,
});

// GS1ResourceCreate { ... }
const GS1ResourceCreateBcs = bcs.struct("GS1ResourceCreate", {
  canonical_id: MoveStringBcs,
  id_level: bcs.u8(),
  primary_key_type: bcs.u8(),
  ...
  extensions: bcs.vector(KeyValueBcs),
});
 ...
 */
export function encodeGS1ResourceCreate(args: GS1ResourceCreate) {
...
export function encodeKeyValueStruct(kv: KeyValue) {
