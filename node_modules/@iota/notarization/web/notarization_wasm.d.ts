...
export interface InitOutput {
    ...
    readonly __wbg_createnotarizationdynamic_free: (a: number, b: number) => void;
    readonly __wbg_createnotarizationlocked_free: (a: number, b: number) => void;
    readonly __wbg_destroynotarization_free: (a: number, b: number) => void;
    readonly __wbg_notarizationresourcebuilder_free: (a: number, b: number) => void;
    readonly __wbg_onchainnotarization_free: (a: number, b: number) => void;
    readonly __wbg_transfernotarization_free: (a: number, b: number) => void;
    readonly __wbg_updatemetadata_free: (a: number, b: number) => void;
    readonly __wbg_updatestate_free: (a: number, b: number) => void;
    readonly createnotarizationdynamic_applyWithEvents: (a: number, b: any, c: any, d: any) => any;
    readonly createnotarizationdynamic_buildProgrammableTransaction: (a: number, b: any) => any;
    readonly createnotarizationdynamic_new: (a: number) => number;
    readonly createnotarizationlocked_applyWithEvents: (a: number, b: any, c: any, d: any) => any;
    readonly createnotarizationlocked_buildProgrammableTransaction: (a: number, b: any) => any;
    readonly createnotarizationlocked_new: (a: number) => number;
    readonly destroynotarization_applyWithEvents: (a: number, b: any, c: any, d: any) => any;
    readonly destroynotarization_buildProgrammableTransaction: (a: number, b: any) => any;
    readonly destroynotarization_new: (a: number, b: number) => [number, number, number];
    readonly notarizationresourcebuilder_data: (a: number) => [number, number];
    readonly notarizationresourcebuilder_immutableMetadata: (a: number) => [number, number];
    readonly notarizationresourcebuilder_owner: (a: number) => [number, number];
    readonly notarizationresourcebuilder_stateMetadata: (a: number) => [number, number];
    readonly notarizationresourcebuilder_updatableMetadata: (a: number) => [number, number];
    readonly onchainnotarization_id: (a: number) => [number, number];
    readonly onchainnotarization_immutableMetadata: (a: number) => number;
    readonly onchainnotarization_iotaResourceLocatorBuilder: (a: number, b: number, c: number) => [number, number, number];
    readonly onchainnotarization_lastStateChangeAt: (a: number) => bigint;
    readonly onchainnotarization_method: (a: number) => number;
    readonly onchainnotarization_owner: (a: number) => [number, number];
    readonly onchainnotarization_state: (a: number) => number;
    readonly onchainnotarization_stateVersionCount: (a: number) => bigint;
    readonly onchainnotarization_updatableMetadata: (a: number) => [number, number];
    readonly transfernotarization_applyWithEvents: (a: number, b: any, c: any, d: any) => any;
    readonly transfernotarization_buildProgrammableTransaction: (a: number, b: any) => any;
    readonly transfernotarization_new: (a: number, b: number, c: number, d: number) => [number, number, number];
    ...
    readonly updatemetadata_new: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly updatestate_applyWithEvents: (a: number, b: any, c: any, d: any) => any;
    readonly updatestate_buildProgrammableTransaction: (a: number, b: any) => any;
    readonly updatestate_new: (a: number, b: number, c: number) => [number, number, number];
    readonly __wbg_notarizationclientreadonly_free: (a: number, b: number) => void;
    readonly notarizationclientreadonly_chainId: (a: number) => [number, number];
    readonly notarizationclientreadonly_create: (a: any) => any;
    readonly notarizationclientreadonly_createWithPkgId: (a: any, b: number, c: number) => any;
    readonly notarizationclientreadonly_createdAtTs: (a: number, b: number, c: number) => any;
    readonly notarizationclientreadonly_description: (a: number, b: number, c: number) => any;
    readonly notarizationclientreadonly_getNotarizationById: (a: number, b: number, c: number) => any;
    readonly notarizationclientreadonly_iotaClient: (a: number) => any;
    readonly notarizationclientreadonly_isDestroyAllowed: (a: number, b: number, c: number) => any;
    readonly notarizationclientreadonly_isTransferLocked: (a: number, b: number, c: number) => any;
    readonly notarizationclientreadonly_isUpdateLocked: (a: number, b: number, c: number) => any;
    readonly notarizationclientreadonly_lastStateChangeTs: (a: number, b: number, c: number) => any;
    readonly notarizationclientreadonly_lockMetadata: (a: number, b: number, c: number) => any;
    readonly notarizationclientreadonly_network: (a: number) => [number, number];
    readonly notarizationclientreadonly_notarizationMethod: (a: number, b: number, c: number) => any;
    readonly notarizationclientreadonly_packageHistory: (a: number) => [number, number];
    readonly notarizationclientreadonly_packageId: (a: number) => [number, number];
    readonly notarizationclientreadonly_state: (a: number, b: number, c: number) => any;
    readonly notarizationclientreadonly_stateVersionCount: (a: number, b: number, c: number) => any;
    readonly notarizationclientreadonly_updatableMetadata: (a: number, b: number, c: number) => any;
    readonly __wbg_notarizationclient_free: (a: number, b: number) => void;
    readonly notarizationclient_create: (a: number, b: any) => any;
    readonly notarizationclient_createDynamic: (a: number) => number;
    readonly notarizationclient_createLocked: (a: number) => number;
    readonly notarizationclient_destroy: (a: number, b: number, c: number) => [number, number, number];
    readonly notarizationclient_iotaClient: (a: number) => any;
    readonly notarizationclient_network: (a: number) => [number, number];
    readonly notarizationclient_packageHistory: (a: number) => [number, number];
    readonly notarizationclient_packageId: (a: number) => [number, number];
    readonly notarizationclient_readOnly: (a: number) => number;
    readonly notarizationclient_senderAddress: (a: number) => [number, number];
    readonly notarizationclient_senderPublicKey: (a: number) => [number, number, number];
    readonly notarizationclient_signer: (a: number) => any;
    readonly notarizationclient_transferNotarization: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly notarizationclient_updateMetadata: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly notarizationclient_updateState: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly __wbg_data_free: (a: number, b: number) => void;
    readonly __wbg_empty_free: (a: number, b: number) => void;
    readonly __wbg_get_lockmetadata_deleteLock: (a: number) => number;
    readonly __wbg_get_lockmetadata_transferLock: (a: number) => number;
    readonly __wbg_get_lockmetadata_updateLock: (a: number) => number;
    readonly __wbg_immutablemetadata_free: (a: number, b: number) => void;
    readonly __wbg_lockmetadata_free: (a: number, b: number) => void;
    readonly __wbg_set_lockmetadata_deleteLock: (a: number, b: number) => void;
    readonly __wbg_set_lockmetadata_transferLock: (a: number, b: number) => void;
    readonly __wbg_set_lockmetadata_updateLock: (a: number, b: number) => void;
    ...
    readonly immutablemetadata_createdAt: (a: number) => bigint;
    readonly immutablemetadata_description: (a: number) => [number, number];
    readonly immutablemetadata_locking: (a: number) => number;
    readonly start: () => void;
    readonly state_data: (a: number) => number;
    readonly state_fromBytes: (a: any, b: number, c: number) => number;
    readonly state_fromString: (a: number, b: number, c: number, d: number) => number;
    readonly state_metadata: (a: number) => [number, number];
    readonly __wbg_notarizationbuilderdynamic_free: (a: number, b: number) => void;
    readonly __wbg_notarizationbuilderlocked_free: (a: number, b: number) => void;
    readonly __wbg_timelock_free: (a: number, b: number) => void;
    readonly notarizationbuilderdynamic_dynamic: () => number;
    readonly notarizationbuilderdynamic_finish: (a: number) => [number, number, number];
    readonly notarizationbuilderdynamic_withBytesState: (a: number, b: any, c: number, d: number) => number;
    readonly notarizationbuilderdynamic_withImmutableDescription: (a: number, b: number, c: number) => number;
    readonly notarizationbuilderdynamic_withStringState: (a: number, b: number, c: number, d: number, e: number) => number;
    readonly notarizationbuilderdynamic_withTransferLock: (a: number, b: number) => number;
    readonly notarizationbuilderdynamic_withUpdatableMetadata: (a: number, b: number, c: number) => number;
    readonly notarizationbuilderlocked_finish: (a: number) => [number, number, number];
    readonly notarizationbuilderlocked_locked: () => number;
    readonly notarizationbuilderlocked_withBytesState: (a: number, b: any, c: number, d: number) => number;
    readonly notarizationbuilderlocked_withDeleteLock: (a: number, b: number) => number;
    readonly notarizationbuilderlocked_withImmutableDescription: (a: number, b: number, c: number) => number;
    readonly notarizationbuilderlocked_withStringState: (a: number, b: number, c: number, d: number, e: number) => number;
    readonly notarizationbuilderlocked_withUpdatableMetadata: (a: number, b: number, c: number) => number;
    ...
    readonly wasm_bindgen__closure__destroy__he274c7612c2cdf2d: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__h11897565e3807735: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h181b99ae310a6b1a: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h988e59c34d869290: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hc446bd59f2e3ed57: (a: number, b: number) => void;
