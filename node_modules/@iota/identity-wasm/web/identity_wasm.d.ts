...
interface ILinkedVerifiablePresentationService {
  ...
  readonly id: DIDUrl;
  /** A unique URI that may be used to identify the {@link Credential}. */
  readonly linkedVp: string | string[];
  /** Miscellaneous properties. */
  readonly [properties: string]: unknown;
}
...
interface IPresentation {
  ...
  readonly verifiableCredential: Jwt | EnvelopedVc | Credential | Record<string, any> | Array<Jwt | EnvelopedVc | Credential | Record<string, any>>;
...
*/
   ...
   */
  static expandDIDCompositeJwk(did: DIDCompositeJwk): CoreDocument;
  /**
   ...
   * private key backed by the `storage` in accordance with the passed `options`.
   */
  createCredentialV2Jwt(storage: Storage, fragment: string, credential: CredentialV2, options: JwsSignatureOptions): Promise<JwtVcV2>;
  /**
   ...
   */
  static newDidJwk(storage: Storage, key_type: string, alg: JwsAlgorithm): Promise<CoreDocument>;
  /**
   * Produces a PQ JWS, from a document with a PQ method, where the payload is produced from the given `fragment` and
   * `payload`.
   */
  createPqJws(storage: Storage, fragment: string, payload: string, options: JwsSignatureOptions): Promise<Jws>;
  /**
   * Creates a new zk DID Document with the given `key_type` and `alg` with the JWK did method.
   */
  static newDidJwkZk(storage: Storage, alg: ProofAlgorithm): Promise<CoreDocument>;
  /**
   * Creates a new PQ DID Document with the given `key_type` and `alg` with the JWK did method.
   */
  static newDidJwkPq(storage: Storage, key_type: string, alg: JwsAlgorithm): Promise<CoreDocument>;
  /**
   ...
   */
  createHybridJws(storage: Storage, fragment: string, payload: string, options: JwsSignatureOptions): Promise<Jws>;
  /**
   * Creates a new hybrid DID Document with the given `key_type` and `alg`with the compositeJWK did method.
   */
  static newDidCompositeJwk(storage: Storage, alg: CompositeAlgId): Promise<CoreDocument>;
   ...
   * The `custom_claims` can be used to set additional claims on the resulting JWT.
   */
  createCredentialJwtPqc(storage: Storage, fragment: string, credential: Credential, options: JwsSignatureOptions, custom_claims?: Record<string, any> | null): Promise<Jwt>;
  /**
   ...
   * private key backed by the `storage` in accordance with the passed `options`.
   */
  createPresentationJwtPqc(storage: Storage, fragment: string, presentation: Presentation, signature_options: JwsSignatureOptions, presentation_options: JwtPresentationOptions): Promise<Jwt>;
  /**
   ...
   * The `custom_claims` can be used to set additional claims on the resulting JWT.
   */
  createCredentialJwtHybrid(storage: Storage, fragment: string, credential: Credential, options: JwsSignatureOptions, custom_claims?: Record<string, any> | null): Promise<Jwt>;
  /**
   * Produces an hybrid JWT, from a document with an hybrid method, where the payload is produced from the given
   ...
   * private key backed by the `storage` in accordance with the passed `options`.
   */
  createPresentationJwtHybrid(storage: Storage, fragment: string, presentation: Presentation, signature_options: JwsSignatureOptions, presentation_options: JwtPresentationOptions): Promise<Jwt>;
  fragmentJwk(): string;
}
...
*/
   ...
   */
  id(): string | undefined;
  static createDomainLinkageCredential(values: IDomainLinkageCredential): CredentialV2;
  /**
   * Constructs a new {@link Credential}.
   */
  constructor(values: ICredentialV2);
  /**
   * Optional cryptographic proof, unrelated to JWT.
   */
  proof(): Proof | undefined;
   ...
   * Deserializes an instance from a JSON object.
   */
  static fromJSON(json: any): CredentialV2;
}
/**
...
export class DIDCompositeJwk {
   ...
   */
  static parse(input: string): DIDCompositeJwk;
  /**
   * Returns the {@link CoreDID} method name.
   *
   * E.g.
   ...
   * Deserializes an instance from a JSON object.
   */
  static fromJSON(json: any): DIDCompositeJwk;
  /**
   * Returns the {@link CoreDID} method-specific ID.
   *
   * E.g.
...
export class EnvelopedVc {
   ...
   */
  constructor(vc_data_url: string);
  /**
   * Serializes this to a JSON object.
   */
  toJSON(): any;
   ...
   * Deserializes an instance from a JSON object.
   */
  static fromJSON(json: any): EnvelopedVc;
  /**
   * Data URL-encoded VC.
   */
  readonly id: string;
   ...
   */
  readonly context: Array<string | Record<string, any>>;
}
...
export class IdentityClient {
   ...
   */
  controlledDids(): Promise<IotaDID[]>;
   ...
   */
  didsControlledBy(address: string): Promise<IotaDID[]>;
...
*/
   ...
   * network name.
   */
  static fromObjectId(objectId: string, network: string): IotaDID;
  /**
...
*/
   ...
   * The fragment of the generated method is returned.
   */
  generateMethodPQC(storage: Storage, keyType: string, alg: JwsAlgorithm, fragment: string | null | undefined, scope: MethodScope): Promise<string>;
  /**
   ...
   * The fragment of the generated method is returned.
   */
  generateMethodHybrid(storage: Storage, alg: CompositeAlgId, fragment: string | null | undefined, scope: MethodScope): Promise<string>;
  /**
   * Produces a PQ JWT, from a document with a PQ method, where the payload is produced from the given `credential`
   * in accordance with [VC Data Model v1.1](https://www.w3.org/TR/vc-data-model/#json-web-token).
   *
...
export class IrlResolver {
  free(): void;
  constructor(params?: IrlResolverParams | null);
  /**
   * Resolves an IOTA Resource Locator (IRL) to its corresponding resource.
   */
  resolve(irl: string): Promise<any>;
}
...
export class Jwk {
   ...
   */
  paramsAkp(): JwkParamsAkp | undefined;
  /**
...
export class JwtCredentialValidator {
   ...
   */
  validateV2(credential_jwt: JwtVcV2, issuer: CoreDocument | IToCoreDocument, options: JwtCredentialValidationOptions, fail_fast: FailFast): DecodedJwtCredentialV2;
  /**
   * Checks whether the credential status has been revoked.
   *
   * Only supports `RevocationBitmap2022`.
   */
  static checkStatus(credential: Credential | CredentialV2, trustedIssuers: Array<CoreDocument | IToCoreDocument>, statusCheck: StatusCheck): void;
  /**
   * Utility for extracting the issuer field of a {@link Credential} as a DID.
   *
   * ### Errors
   ...
   * Fails if the issuer field is not a valid DID.
   */
  static extractIssuer(credential: Credential | CredentialV2): CoreDID;
  /**
   ...
   * to verify the credential's signature will be made and an error is returned upon failure.
   */
  verifySignatureV2(credential: JwtVcV2, trustedIssuers: Array<CoreDocument | IToCoreDocument>, options: JwsVerificationOptions): DecodedJwtCredentialV2;
  /**
   ...
   */
  static extractIssuerFromJwt(credential: Jwt | JwtVcV2): CoreDID;
  /**
   * Validate that the credential expires on or after the specified timestamp.
   */
  static checkExpiresOnOrAfter(credential: Credential | CredentialV2, timestamp: Timestamp): void;
  /**
   * Validate that the credential is issued on or before the specified timestamp.
   */
  static checkIssuedOnOrBefore(credential: Credential | CredentialV2, timestamp: Timestamp): void;
  /**
   * Validate that the relationship between the `holder` and the credential subjects is in accordance with
   * `relationship`. The `holder` parameter is expected to be the URL of the holder.
   */
  static checkSubjectHolderRelationship(credential: Credential | CredentialV2, holder: string, relationship: SubjectHolderRelationship): void;
  /**
   * Checks whether the credential status has been revoked using `StatusList2021`.
   */
  static checkStatusWithStatusList2021(credential: Credential | CredentialV2, status_list: StatusList2021Credential, status_check: StatusCheck): void;
  /**
...
export class JwtCredentialValidatorHybrid {
   ...
   */
  constructor(traditionalSignatureVerifier?: IJwsVerifier | null, pqSignatureVerifier?: IJwsVerifier | null);
  /**
   * Decodes and validates a {@link Credential} issued as a JWS. A {@link DecodedJwtCredential} is returned upon
   * success.
   *
...
export class JwtVcV2 {
   ...
   */
  static fromEnvelopedVc(enveloped_vc: EnvelopedVc): JwtVcV2;
  toString(): string;
}
/**
 * Options to declare validation criteria when validating credentials.
...
*/
   ...
   */
  static newV2(values: IPresentation): Presentation;
  /**
...
export class UnknownCredential {
   ...
   */
  tryIntoEnvelopedVc(): EnvelopedVc | undefined;
  /**
   * Serializes this to a JSON object.
   */
  toJSON(): any;
...
export interface InitOutput {
  ...
  readonly identityclient_controlledDids: (a: number) => any;
  ...
  readonly identityclient_didsControlledBy: (a: number, b: number, c: number) => any;
  ...
  readonly identityclientreadonly_didsControlledBy: (a: number, b: number, c: number) => any;
  ...
  readonly __wbg_jwtvcv2_free: (a: number, b: number) => void;
  ...
  readonly jwtvcv2_clone: (a: number) => number;
  readonly jwtvcv2_fromEnvelopedVc: (a: number) => [number, number, number];
  readonly jwtvcv2_intoEnvelopedVc: (a: number) => number;
  readonly jwtvcv2_toString: (a: number) => [number, number];
  ...
  readonly __wbg_irlresolver_free: (a: number, b: number) => void;
  ...
  readonly didjwk_fromJwk: (a: number) => number;
  ...
  readonly irlresolver_new: (a: number) => [number, number, number];
  readonly irlresolver_resolve: (a: number, b: number, c: number) => any;
  ...
  readonly jwk_paramsAkp: (a: number) => [number, number, number];
  ...
  readonly __wbg_compositejwk_free: (a: number, b: number) => void;
  readonly __wbg_createupdatedidproposal_free: (a: number, b: number) => void;
  readonly __wbg_didcompositejwk_free: (a: number, b: number) => void;
  readonly __wbg_envelopedvc_free: (a: number, b: number) => void;
  ...
  readonly compositejwk_alg_id: (a: number) => any;
  readonly compositejwk_new: (a: any) => [number, number, number];
  readonly compositejwk_pq_public_key: (a: number) => number;
  readonly compositejwk_traditional_public_key: (a: number) => number;
  ...
  readonly didcompositejwk_authority: (a: number) => [number, number];
  readonly didcompositejwk_clone: (a: number) => number;
  readonly didcompositejwk_compositeJwk: (a: number) => number;
  readonly didcompositejwk_fromJSON: (a: any) => [number, number, number];
  readonly didcompositejwk_method: (a: number) => [number, number];
  readonly didcompositejwk_methodId: (a: number) => [number, number];
  readonly didcompositejwk_new: (a: any) => [number, number, number];
  readonly didcompositejwk_parse: (a: number, b: number) => [number, number, number];
  readonly didcompositejwk_scheme: (a: number) => [number, number];
  readonly didcompositejwk_toCoreDid: (a: number) => number;
  readonly didcompositejwk_toJSON: (a: number) => [number, number, number];
  readonly didcompositejwk_toString: (a: number) => [number, number];
  readonly envelopedvc_context: (a: number) => [number, number, number];
  readonly envelopedvc_fromJSON: (a: any) => [number, number, number];
  readonly envelopedvc_id: (a: number) => [number, number];
  readonly envelopedvc_new: (a: number, b: number) => [number, number, number];
  readonly envelopedvc_toJSON: (a: number) => [number, number, number];
  readonly envelopedvc_type: (a: number) => [number, number];
  ...
  readonly __wbg_credentialv2_free: (a: number, b: number) => void;
  ...
  readonly __wbg_decodedjwtcredentialv2_free: (a: number, b: number) => void;
  ...
  readonly __wbg_jwtcredentialvalidatorhybrid_free: (a: number, b: number) => void;
  ...
  readonly __wbg_jwtpresentationvalidatorhybrid_free: (a: number, b: number) => void;
  ...
  readonly coredocument_createCredentialJwtHybrid: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
  readonly coredocument_createCredentialJwtPqc: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
  readonly coredocument_createCredentialV2Jwt: (a: number, b: number, c: number, d: number, e: number, f: number) => any;
  readonly coredocument_createHybridJws: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
  readonly coredocument_createJws: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
  readonly coredocument_createPqJws: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
  readonly coredocument_createPresentationJpt: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
  ...
  readonly coredocument_createPresentationJwtHybrid: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
  readonly coredocument_createPresentationJwtPqc: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
  readonly coredocument_detachMethodRelationship: (a: number, b: number, c: number) => [number, number, number];
  readonly coredocument_expandDIDCompositeJwk: (a: number) => [number, number, number];
  readonly coredocument_expandDIDJwk: (a: number) => [number, number, number];
  readonly coredocument_fragmentJwk: (a: number) => [number, number];
  ...
  readonly coredocument_newDidCompositeJwk: (a: number, b: any) => any;
  readonly coredocument_newDidJwk: (a: number, b: number, c: number, d: any) => any;
  readonly coredocument_newDidJwkPq: (a: number, b: number, c: number, d: any) => any;
  readonly coredocument_newDidJwkZk: (a: number, b: number) => any;
  ...
  readonly credentialv2_BaseContext: () => [number, number, number, number];
  readonly credentialv2_clone: (a: number) => number;
  readonly credentialv2_context: (a: number) => [number, number, number];
  readonly credentialv2_createDomainLinkageCredential: (a: any) => [number, number, number];
  readonly credentialv2_credentialSchema: (a: number) => [number, number, number];
  readonly credentialv2_credentialStatus: (a: number) => [number, number, number];
  readonly credentialv2_credentialSubject: (a: number) => [number, number, number];
  readonly credentialv2_evidence: (a: number) => [number, number, number];
  readonly credentialv2_fromJSON: (a: any) => [number, number, number];
  readonly credentialv2_id: (a: number) => [number, number];
  readonly credentialv2_issuer: (a: number) => [number, number, number];
  readonly credentialv2_new: (a: any) => [number, number, number];
  readonly credentialv2_nonTransferable: (a: number) => number;
  readonly credentialv2_proof: (a: number) => number;
  readonly credentialv2_properties: (a: number) => [number, number, number];
  readonly credentialv2_refreshService: (a: number) => [number, number, number];
  readonly credentialv2_termsOfUse: (a: number) => [number, number, number];
  readonly credentialv2_toJSON: (a: number) => [number, number, number];
  readonly credentialv2_toJwtClaims: (a: number, b: number) => [number, number, number];
  readonly credentialv2_type: (a: number) => any;
  readonly credentialv2_validFrom: (a: number) => number;
  readonly credentialv2_validUntil: (a: number) => number;
  ...
  readonly decodedjwtcredentialv2_credential: (a: number) => number;
  readonly decodedjwtcredentialv2_intoCredential: (a: number) => number;
  readonly decodedjwtcredentialv2_protectedHeader: (a: number) => number;
  ...
  readonly iotadid_fromObjectId: (a: number, b: number, c: number, d: number) => [number, number, number];
  ...
  readonly iotadid_toObjectID: (a: number) => [number, number];
  ...
  readonly iotadocument_createCredentialJwtHybrid: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
  readonly iotadocument_createCredentialJwtPqc: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
  readonly iotadocument_createCredentialV2Jwt: (a: number, b: number, c: number, d: number, e: number, f: number) => any;
  readonly iotadocument_createHybridJws: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
  ...
  readonly iotadocument_createPqJws: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
  ...
  readonly iotadocument_createPresentationJwtHybrid: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
  readonly iotadocument_createPresentationJwtPqc: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
  ...
  readonly iotadocument_generateMethodHybrid: (a: number, b: number, c: any, d: number, e: number, f: number) => [number, number, number];
  readonly iotadocument_generateMethodJwp: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
  readonly iotadocument_generateMethodPQC: (a: number, b: number, c: number, d: number, e: any, f: number, g: number, h: number) => [number, number, number];
  ...
  readonly jwtcredentialvalidator_checkExpiresOnOrAfter: (a: any, b: number) => [number, number];
  readonly jwtcredentialvalidator_checkIssuedOnOrBefore: (a: any, b: number) => [number, number];
  readonly jwtcredentialvalidator_checkStatus: (a: any, b: any, c: number) => [number, number];
  readonly jwtcredentialvalidator_checkStatusWithStatusList2021: (a: any, b: number, c: number) => [number, number];
  readonly jwtcredentialvalidator_checkSubjectHolderRelationship: (a: any, b: number, c: number, d: number) => [number, number];
  readonly jwtcredentialvalidator_extractIssuer: (a: any) => [number, number, number];
  readonly jwtcredentialvalidator_extractIssuerFromJwt: (a: any) => [number, number, number];
  ...
  readonly jwtcredentialvalidator_validateV2: (a: number, b: number, c: any, d: number, e: number) => [number, number, number];
  readonly jwtcredentialvalidator_verifySignature: (a: number, b: number, c: any, d: number) => [number, number, number];
  readonly jwtcredentialvalidator_verifySignatureV2: (a: number, b: number, c: any, d: number) => [number, number, number];
  readonly jwtcredentialvalidatorhybrid_checkExpiresOnOrAfter: (a: number, b: number) => [number, number];
  readonly jwtcredentialvalidatorhybrid_checkIssuedOnOrBefore: (a: number, b: number) => [number, number];
  readonly jwtcredentialvalidatorhybrid_checkStatus: (a: number, b: any, c: number) => [number, number];
  readonly jwtcredentialvalidatorhybrid_checkStatusWithStatusList2021: (a: number, b: number, c: number) => [number, number];
  readonly jwtcredentialvalidatorhybrid_checkSubjectHolderRelationship: (a: number, b: number, c: number, d: number) => [number, number];
  readonly jwtcredentialvalidatorhybrid_extractIssuer: (a: number) => [number, number, number];
  readonly jwtcredentialvalidatorhybrid_extractIssuerFromJwt: (a: number) => [number, number, number];
  readonly jwtcredentialvalidatorhybrid_new: (a: number, b: number) => number;
  readonly jwtcredentialvalidatorhybrid_validate: (a: number, b: number, c: any, d: number, e: number) => [number, number, number];
  readonly jwtcredentialvalidatorhybrid_verifySignature: (a: number, b: number, c: any, d: number) => [number, number, number];
  ...
  readonly jwtpresentationvalidatorhybrid_new: (a: number, b: number) => number;
  readonly jwtpresentationvalidatorhybrid_validate: (a: number, b: number, c: any, d: number) => [number, number, number];
  ...
  readonly presentation_newV2: (a: any) => [number, number, number];
  ...
  readonly unknowncredential_tryIntoEnvelopedVc: (a: number) => number;
  ...
  readonly credentialv2_BaseType: () => [number, number];
  readonly jwsheader_x5c: (a: number) => any;
  readonly jwtpresentationvalidatorhybrid_checkStructure: (a: number) => [number, number];
  readonly iotadid_static_method: () => [number, number];
  readonly jwtpresentationvalidatorhybrid_extractHolder: (a: number) => [number, number, number];
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h61520a3f955e4ccc: (a: number, b: number) => void;
  readonly closure4786_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure5014_externref_shim: (a: number, b: number, c: any, d: any) => void;
