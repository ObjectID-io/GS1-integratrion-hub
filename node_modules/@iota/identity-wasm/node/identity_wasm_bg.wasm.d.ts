...
export const identityclient_controlledDids: (a: number) => any;
...
export const identityclient_didsControlledBy: (a: number, b: number, c: number) => any;
...
export const identityclientreadonly_didsControlledBy: (a: number, b: number, c: number) => any;
...
export const didjwk_fromJwk: (a: number) => number;
...
export const jwk_paramsAkp: (a: number) => [number, number, number];
...
export const __wbg_compositejwk_free: (a: number, b: number) => void;
export const __wbg_createsendproposal_free: (a: number, b: number) => void;
export const __wbg_didcompositejwk_free: (a: number, b: number) => void;
export const __wbg_disclosurev2_free: (a: number, b: number) => void;
export const __wbg_envelopedvc_free: (a: number, b: number) => void;
...
export const compositejwk_alg_id: (a: number) => any;
export const compositejwk_new: (a: any) => [number, number, number];
export const compositejwk_pq_public_key: (a: number) => number;
export const compositejwk_traditional_public_key: (a: number) => number;
...
export const didcompositejwk_authority: (a: number) => [number, number];
export const didcompositejwk_clone: (a: number) => number;
export const didcompositejwk_compositeJwk: (a: number) => number;
export const didcompositejwk_fromJSON: (a: any) => [number, number, number];
export const didcompositejwk_method: (a: number) => [number, number];
export const didcompositejwk_methodId: (a: number) => [number, number];
export const didcompositejwk_new: (a: any) => [number, number, number];
export const didcompositejwk_parse: (a: number, b: number) => [number, number, number];
export const didcompositejwk_scheme: (a: number) => [number, number];
export const didcompositejwk_toCoreDid: (a: number) => number;
export const didcompositejwk_toJSON: (a: number) => [number, number, number];
export const didcompositejwk_toString: (a: number) => [number, number];
...
export const envelopedvc_context: (a: number) => [number, number, number];
export const envelopedvc_fromJSON: (a: any) => [number, number, number];
export const envelopedvc_id: (a: number) => [number, number];
export const envelopedvc_new: (a: number, b: number) => [number, number, number];
export const envelopedvc_toJSON: (a: number) => [number, number, number];
export const envelopedvc_type: (a: number) => [number, number];
...
export const __wbg_credentialv2_free: (a: number, b: number) => void;
...
export const __wbg_decodedjwtcredentialv2_free: (a: number, b: number) => void;
...
export const __wbg_jwtcredentialvalidatorhybrid_free: (a: number, b: number) => void;
export const __wbg_jwtpresentationvalidatorhybrid_free: (a: number, b: number) => void;
...
export const coredocument_createCredentialJwtHybrid: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
export const coredocument_createCredentialJwtPqc: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
export const coredocument_createCredentialV2Jwt: (a: number, b: number, c: number, d: number, e: number, f: number) => any;
export const coredocument_createHybridJws: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
export const coredocument_createJws: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
export const coredocument_createPqJws: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
export const coredocument_createPresentationJpt: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
...
export const coredocument_createPresentationJwtHybrid: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
export const coredocument_createPresentationJwtPqc: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
export const coredocument_detachMethodRelationship: (a: number, b: number, c: number) => [number, number, number];
export const coredocument_expandDIDCompositeJwk: (a: number) => [number, number, number];
export const coredocument_expandDIDJwk: (a: number) => [number, number, number];
export const coredocument_fragmentJwk: (a: number) => [number, number];
...
export const coredocument_newDidCompositeJwk: (a: number, b: any) => any;
export const coredocument_newDidJwk: (a: number, b: number, c: number, d: any) => any;
export const coredocument_newDidJwkPq: (a: number, b: number, c: number, d: any) => any;
export const coredocument_newDidJwkZk: (a: number, b: number) => any;
...
export const credentialv2_BaseContext: () => [number, number, number, number];
export const credentialv2_clone: (a: number) => number;
export const credentialv2_context: (a: number) => [number, number, number];
export const credentialv2_createDomainLinkageCredential: (a: any) => [number, number, number];
export const credentialv2_credentialSchema: (a: number) => [number, number, number];
export const credentialv2_credentialStatus: (a: number) => [number, number, number];
export const credentialv2_credentialSubject: (a: number) => [number, number, number];
export const credentialv2_evidence: (a: number) => [number, number, number];
export const credentialv2_fromJSON: (a: any) => [number, number, number];
export const credentialv2_id: (a: number) => [number, number];
export const credentialv2_issuer: (a: number) => [number, number, number];
export const credentialv2_new: (a: any) => [number, number, number];
export const credentialv2_nonTransferable: (a: number) => number;
export const credentialv2_proof: (a: number) => number;
export const credentialv2_properties: (a: number) => [number, number, number];
export const credentialv2_refreshService: (a: number) => [number, number, number];
export const credentialv2_termsOfUse: (a: number) => [number, number, number];
export const credentialv2_toJSON: (a: number) => [number, number, number];
export const credentialv2_toJwtClaims: (a: number, b: number) => [number, number, number];
export const credentialv2_type: (a: number) => any;
export const credentialv2_validFrom: (a: number) => number;
export const credentialv2_validUntil: (a: number) => number;
...
export const decodedjwtcredentialv2_credential: (a: number) => number;
export const decodedjwtcredentialv2_intoCredential: (a: number) => number;
export const decodedjwtcredentialv2_protectedHeader: (a: number) => number;
...
export const iotadid_fromObjectId: (a: number, b: number, c: number, d: number) => [number, number, number];
...
export const iotadid_toObjectID: (a: number) => [number, number];
...
export const iotadocument_createCredentialJwtHybrid: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
export const iotadocument_createCredentialJwtPqc: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
export const iotadocument_createCredentialV2Jwt: (a: number, b: number, c: number, d: number, e: number, f: number) => any;
export const iotadocument_createHybridJws: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
...
export const iotadocument_createPqJws: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
...
export const iotadocument_createPresentationJwtHybrid: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
export const iotadocument_createPresentationJwtPqc: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
...
export const iotadocument_generateMethodHybrid: (a: number, b: number, c: any, d: number, e: number, f: number) => [number, number, number];
export const iotadocument_generateMethodJwp: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
export const iotadocument_generateMethodPQC: (a: number, b: number, c: number, d: number, e: any, f: number, g: number, h: number) => [number, number, number];
...
export const jwtcredentialvalidator_checkExpiresOnOrAfter: (a: any, b: number) => [number, number];
export const jwtcredentialvalidator_checkIssuedOnOrBefore: (a: any, b: number) => [number, number];
export const jwtcredentialvalidator_checkStatus: (a: any, b: any, c: number) => [number, number];
export const jwtcredentialvalidator_checkStatusWithStatusList2021: (a: any, b: number, c: number) => [number, number];
export const jwtcredentialvalidator_checkSubjectHolderRelationship: (a: any, b: number, c: number, d: number) => [number, number];
export const jwtcredentialvalidator_extractIssuer: (a: any) => [number, number, number];
export const jwtcredentialvalidator_extractIssuerFromJwt: (a: any) => [number, number, number];
...
export const jwtcredentialvalidator_validateV2: (a: number, b: number, c: any, d: number, e: number) => [number, number, number];
export const jwtcredentialvalidator_verifySignature: (a: number, b: number, c: any, d: number) => [number, number, number];
export const jwtcredentialvalidator_verifySignatureV2: (a: number, b: number, c: any, d: number) => [number, number, number];
export const jwtcredentialvalidatorhybrid_checkExpiresOnOrAfter: (a: number, b: number) => [number, number];
export const jwtcredentialvalidatorhybrid_checkIssuedOnOrBefore: (a: number, b: number) => [number, number];
export const jwtcredentialvalidatorhybrid_checkStatus: (a: number, b: any, c: number) => [number, number];
export const jwtcredentialvalidatorhybrid_checkStatusWithStatusList2021: (a: number, b: number, c: number) => [number, number];
export const jwtcredentialvalidatorhybrid_checkSubjectHolderRelationship: (a: number, b: number, c: number, d: number) => [number, number];
export const jwtcredentialvalidatorhybrid_extractIssuer: (a: number) => [number, number, number];
export const jwtcredentialvalidatorhybrid_extractIssuerFromJwt: (a: number) => [number, number, number];
export const jwtcredentialvalidatorhybrid_new: (a: number, b: number) => number;
export const jwtcredentialvalidatorhybrid_validate: (a: number, b: number, c: any, d: number, e: number) => [number, number, number];
export const jwtcredentialvalidatorhybrid_verifySignature: (a: number, b: number, c: any, d: number) => [number, number, number];
export const jwtpresentationvalidatorhybrid_checkStructure: (a: number) => [number, number];
export const jwtpresentationvalidatorhybrid_extractHolder: (a: number) => [number, number, number];
export const jwtpresentationvalidatorhybrid_new: (a: number, b: number) => number;
export const jwtpresentationvalidatorhybrid_validate: (a: number, b: number, c: any, d: number) => [number, number, number];
...
export const presentation_newV2: (a: any) => [number, number, number];
...
export const unknowncredential_tryIntoEnvelopedVc: (a: number) => number;
...
export const credentialv2_BaseType: () => [number, number];
...
export const __wbg_irlresolver_free: (a: number, b: number) => void;
export const __wbg_jptcredentialvalidationoptions_free: (a: number, b: number) => void;
export const __wbg_jwkkeytoolstore_free: (a: number, b: number) => void;
...
export const __wbg_jwtvcv2_free: (a: number, b: number) => void;
export const __wbg_keyidkeytoolstore_free: (a: number, b: number) => void;
...
export const irlresolver_new: (a: number) => [number, number, number];
export const irlresolver_resolve: (a: number, b: number, c: number) => any;
...
export const jwkkeytoolstore_delete: (a: number, b: number, c: number) => any;
export const jwkkeytoolstore_exists: (a: number, b: number, c: number) => any;
export const jwkkeytoolstore_generate: (a: number, b: number, c: number, d: number, e: number) => any;
export const jwkkeytoolstore_insert: (a: number, b: number) => any;
export const jwkkeytoolstore_new: (a: number) => number;
export const jwkkeytoolstore_sign: (a: number, b: number, c: number, d: number, e: number, f: number) => any;
...
export const jwtvcv2_clone: (a: number) => number;
export const jwtvcv2_fromEnvelopedVc: (a: number) => [number, number, number];
export const jwtvcv2_intoEnvelopedVc: (a: number) => number;
export const jwtvcv2_toString: (a: number) => [number, number];
export const keyidkeytoolstore_deleteKeyId: (a: number, b: number) => any;
export const keyidkeytoolstore_getKeyId: (a: number, b: number) => any;
export const keyidkeytoolstore_insertKeyId: (a: number, b: number, c: number, d: number) => any;
export const keyidkeytoolstore_new: (a: number) => number;
...
export const __wasm_exec_iota_cmd: (a: number, b: number, c: number) => void;
export const __wbg_keytoolsigner_free: (a: number, b: number) => void;
export const __wbg_keytoolstorage_free: (a: number, b: number) => void;
export const keytoolsigner_address: (a: number) => [number, number];
export const keytoolsigner_iotaPublicKeyBytes: (a: number) => any;
export const keytoolsigner_new: (a: number, b: number, c: number, d: number) => [number, number, number];
export const keytoolsigner_publicKey: (a: number) => any;
export const keytoolsigner_sign: (a: number, b: number, c: number) => any;
export const keytoolstorage_generateKey: (a: number, b: number, c: number) => [number, number, number];
export const keytoolstorage_getKey: (a: number, b: number, c: number) => [number, number, number];
export const keytoolstorage_getKeyByAlias: (a: number, b: number, c: number) => [number, number, number];
export const keytoolstorage_insertKey: (a: number, b: number, c: number) => [number, number, number, number];
export const keytoolstorage_new: (a: number, b: number) => number;
export const keytoolstorage_signRaw: (a: number, b: number, c: number, d: number, e: number) => [number, number, number, number];
export const keytoolstorage_signer: (a: number, b: number, c: number) => [number, number, number];
export const keytoolstorage_updateAlias: (a: number, b: number, c: number, d: number, e: number) => [number, number];
export const keytoolsigner_keyId: (a: number) => [number, number];
...
export const closure4288_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h61520a3f955e4ccc: (a: number, b: number) => void;
export const closure5257_externref_shim: (a: number, b: number, c: any, d: any) => void;
